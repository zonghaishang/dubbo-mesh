...
public class InternalIntObjectHashMap<V> implements IntObjectMap<V> {
    ...
    public InternalIntObjectHashMap() {
        this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
    }

    public InternalIntObjectHashMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR);
    }

    public InternalIntObjectHashMap(int initialCapacity, float loadFactor) {
    ...
    public void putAll(Map<? extends Integer, ? extends V> sourceMap) {
        if (sourceMap instanceof IntObjectHashMap) {
            ...
            @SuppressWarnings("unchecked")
            InternalIntObjectHashMap<V> source = (InternalIntObjectHashMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Integer, V>> {
        ...
        @Override
        public int size() {
            return InternalIntObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Integer> {
        ...
        public boolean contains(Object o) {
            return InternalIntObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return InternalIntObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            InternalIntObjectHashMap.this.clear();
        }
